...
public class SalonDtlReviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //create Dummy---------------------
        SimpleDateFormat formatDateTime = new SimpleDateFormat(SystemDateUtil.DATE_TIME_FORMAT);
        Date reviewDate = new Date(2017,01,01,01,01,01);
        try {
            //MM//DD//YY
            reviewDate = formatDateTime.parse("10/24/2017 10:10:10");
