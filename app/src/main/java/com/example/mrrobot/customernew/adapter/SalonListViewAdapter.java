...
import com.example.mrrobot.customernew.view_holder.SalonListViewHolder;

import java.util.List;

public class SalonListViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //constraktor
    public SalonListViewAdapter(RecyclerView recyclerView, List<Salon> salons, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM){
            View view = LayoutInflater.from(context).inflate(R.layout.viewholder_list_salon, parent, false);
            return new SalonListViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof SalonListViewHolder){
            final Salon mSalon;
            mSalon = salons.get(position);

            SalonListViewHolder salonViewHolder = (SalonListViewHolder) holder;
