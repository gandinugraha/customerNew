...
import com.example.mrrobot.customernew.activity.ListNewsActivity;
...
import com.example.mrrobot.customernew.listener.ItemClickListener;
    ...
    public void onBindViewHolder(final ListSourceViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                intent.putExtra("sortBy", webSite.getSources().get(position).getSortBysAvailable().get(0)); //get defailt sortBuy
